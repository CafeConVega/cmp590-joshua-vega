			<footer class="footer" role="contentinfo" itemscope itemtype="http://schema.org/WPFooter">
				...
				<div id="inner-footer" class="wrap cf">
					...
					<nav role="navigation">
                        ...
                        <li><a href="http://com.miami.edu/cinema-interactive-media" class="hvr-rotate" target="_blank">UM Cinema </a> <a href="http://interactive.miami.edu" class="hvr-rotate" target="_blank">&amp; Interactive Media</a></li>
						</ul>
					</nav>
