...
!function(jQuery){
  ...
  jQuery.fn.panorama_viewer = function(options){
    ...
    return this.each(function(){
      ...
      el.find("> img").load(function () {
        ...
        if (settings.overlay == true) {
          jQuery("<div class='pv-overlay'><i class='pvicon-overlay'></i></div>").appendTo(el.find(".pv-inner"))

          el.find(".pv-inner").bind("mouseenter", function() {
            jQuery(this).find(".pv-overlay ").fadeOut("fast");
          }).bind("mouseleave", function() {
            jQuery(this).find(".pv-overlay ").fadeIn("fast");
          })
        }


      	var jQuerybg = el.find(".pv-inner"),
        elbounds = {
          w: parseInt(jQuerybg.parent().width()),
          h: parseInt(jQuerybg.parent().height())
        },
        ...
        function move (e){
          ...
          jQuery(this).css('background-position', start.x + 'px ' + start.y + 'px');
        ...
        function handle (e){
            movecontinue = false;
            jQuerybg.unbind('mousemove', move);

            if (e.type == 'mousedown') {
                origin.x = e.clientX;
                origin.y = e.clientY;
                movecontinue = true;
                jQuerybg.bind('mousemove', move);
            } else {
        ...
        jQuerybg.bind('mousedown mouseup mouseleave', handle);
        jQuerybg.bind('dblclick', reset);
